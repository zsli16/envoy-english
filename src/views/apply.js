...
class Application extends Component {
  render() {
    ...
    return (
      <>
      <Container>
        <h1 style={{'text-align': 'center'}}>Register for Our Beta Trial</h1>
        ...
        <Row>
          <HashLink to="/apply/#application"><FontAwesomeIcon id="down-arrow" fa-pulse color='lightgray' size="3x" icon={faChevronDown}/></HashLink>
        </Row>
      </Container>
